...
sendOrder(m.chat, teks, "391028153034238", fs.readFileSync('./worker/media/image/Deff.jpg'), 2022, "IRUZMD", "6289501060783@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
const telestick = async (to, url, wm = "IRUZ", wm2 = '') => {
exif.create(wm, wm2)
...
case 'lava': case 'rock': case 'bloodglas': case 'hallowen': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
             if (!q) return ads(`Example : ${prefix + command} Iruz`) 
             ads(mess.wait)
             let link
...
hydratedFooterText: "© IRUZBOTZ ~ Iruz",
hydratedButtons: [{
urlButton: {
...
url: 'https://instagram.com/iruzssksk'
}
}, {
quickReplyButton: {
...
url: 'https://github.com/Iruz-Xploit/'
}
}, {
urlButton: {
displayText: 'Group Whatsapp',
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© IRUZBOTZ ~ Iruz", log0, btn, thum)
}
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "© IRUZBOTZ ~ Iruz", log0, btn, thum)
}
